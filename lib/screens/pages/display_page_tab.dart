...
class DisplayPageTab extends StatefulWidget {
  const DisplayPageTab({required this.imageNo});
  final double imageNo;

  @override
  State<DisplayPageTab> createState() => _DisplayPageTabState();
}

class _DisplayPageTabState extends State<DisplayPageTab> {
  bool _first = false;
